        ...
        <div class="modal-content border-0 rounded-4 shadow-lg">
            ...
            <div class="modal-body p-4">
                ...
                <div id="title-div" class="mb-2">
                    <label class="form-label small text-muted mb-1">{{__('event.show.title')}}</label>
                ...
                <div id="description-div" class="mb-2">
                    <label class="form-label small text-muted mb-1">{{__('event.show.description')}}</label>
                    <textarea class="form-control rounded-3" rows="2" placeholder="{{__('event.create.description_placeholder')}}" id="input-description"></textarea>
                </div>

                <div class="row g-2 mb-2">
                    <div id="deadline-div" class="col-12 col-md-4">
                        <label class="form-label small text-muted mb-1">{{__('event.show.deadline')}}</label>
                        <input type="date" class="form-control rounded-3" id="input-deadline">
                    </div>
                    <div id="from-div" class="col-6 col-md-4">
                        <label class="form-label small text-muted mb-1">{{__('event.show.from')}}</label>
                        <input type="date" class="form-control rounded-3 border" id="input-from">
                    </div>
                    <div id="to-div" class="col-6 col-md-4">
                        <label class="form-label small text-muted mb-1">{{__('event.show.to')}}</label>
                        <input type="date" class="form-control rounded-3" id="input-to">
                    </div>
                </div>

                <div id="price-div" class="mb-2">
                    <label class="form-label small text-muted mb-1">{{__('event.show.price')}}</label>
                ...
                <button id="save-changes" class="btn btn-primary w-100 py-2 fw-bold shadow-sm mb-3">{{__('event.create.submit')}}</button>
                ...
                <div class="mt-3">
                    ...
                    <div class="position-relative">
                        <input id="searchInput" type="text" class="form-control rounded-pill shadow-sm mb-2" placeholder="{{__('event.create.search_placeholder')}}">
