<!doctype html>
<html lang="{{__('userProfile.language')}}">
<x-head title="{{__('userProfile.title')}}"></x-head>
                        ...
                        <div class="row align-items-center mb-5 g-4">
                            ...
                            <div class="col-12 col-md-8">
                                <div class="card border-0 shadow-sm rounded-4 p-4">
                                    <h5 class="fw-bold text-secondary mb-4">{{__('userProfile.info')}}</h5>

                                    <div class="mb-3">
                                        <label class="form-label small text-muted ms-1">{{__('userProfile.firstName')}}</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label small text-muted ms-1">{{__('userProfile.lastName')}}</label>
                                        <div class="position-relative">
                                    ...
                                    <div class="mb-0">
                                        <label class="form-label small text-muted ms-1">{{__('userProfile.email')}}</label>
                                        <div class="position-relative">
                                            <h4>{{$user->email}}</h4>
                                        </div>
                                    </div>
